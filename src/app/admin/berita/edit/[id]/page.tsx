...
import { updateBerita } from '@/actions/berita'
  ...
  return (
    <div className="space-y-6 pt-16 lg:pt-0 max-w-2xl">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        <form action={updateBerita.bind(null, id)} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Judul *</label>
            <input type="text" name="judul" required defaultValue={berita.judul}
          ...
          <div>
            ...
            <textarea name="ringkasan" required rows={3} defaultValue={berita.ringkasan}
          ...
          <div>
            ...
            <textarea name="isi" rows={6} defaultValue={berita.isi}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" name="kategori" required defaultValue={berita.kategori}
                placeholder="Contoh: Prestasi, PPDB, Akademik"
                className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#0f2557] transition-colors text-sm" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Tipe *</label>
              <select name="tipe" required defaultValue={berita.tipe}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" name="tanggal" required defaultValue={toDateInputValue(berita.tanggal)}
                className="w-full px-4 py-3 border border-gray-200 rounded-xl outline-none focus:border-[#0f2557] transition-colors text-sm" />
            </div>
            <div className="flex items-center gap-3 pt-7">
              <input type="checkbox" name="published" value="true" id="published" defaultChecked={berita.published}
          ...
          <div className="flex items-center gap-3">
            <input type="checkbox" name="prioritas" value="true" id="prioritas" defaultChecked={berita.prioritas}
              className="w-4 h-4 rounded" />
